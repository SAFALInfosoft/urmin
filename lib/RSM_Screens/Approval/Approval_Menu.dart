...
class APPROVAL_MENU extends StatefulWidget {
  APPROVAL_MENU({Key? key}) : super(key: key);

  @override
  _APPROVAL_MENUState createState() => _APPROVAL_MENUState();
}

class _APPROVAL_MENUState extends State<APPROVAL_MENU> {
  @override
                ...
                children: [
                  ...
                  Material(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        RSMOrderApprovalMainScreen().launch(context);
                      },
                      child: Container(
                        width: context.width(),
                        ...
                        child: ListTile(
                          leading:  Image(image: AssetImage('images/order.png'),height: 40,width: 40,),
                          title: Text(
                            'Order Approval',
                            maxLines: 2,
